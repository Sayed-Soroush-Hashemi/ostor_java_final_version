...
public class MostFrequentlyUsedVirtualMemoryScheduler extends SimpleVirtualMemoryScheduler {

    protected HashMap<Thread, Vector<Integer>> useFrequency;
    protected HashMap<Thread, Vector<Integer>> loadingClock;


    public MostFrequentlyUsedVirtualMemoryScheduler(int processLoadablePages) {
